...
| durationMinutes | Float | A timer will count down from starting at the specified the duration. Once it reaches zero, the stage will automatically be completed. If not defined or zero, the timer will count up instead and the stage will not end automatically. | No |
